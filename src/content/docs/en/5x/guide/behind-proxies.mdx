...
<ul>
  <li markdown="1">
    The value of [req.hostname](/en/5x/api/request#reqhostname) is derived from the value set in the
  ...
  <li markdown="1">
    ...
    [req.protocol](/en/5x/api/request#reqprotocol).
  </li>
  <li markdown="1">
    The [req.ip](/en/5x/api/request#reqip) and [req.ips](/en/5x/api/request#reqips) values are
    populated based on the socket address and `X-Forwarded-For` header, starting at the first
    untrusted address.
  </li>
</ul>
