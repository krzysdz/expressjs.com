...
The [Express application generator](/en/4x/starter/generator) uses [Pug](https://pugjs.org/api/getting-started.html) as its default, but it also supports [Handlebars](https://www.npmjs.com/package/handlebars), and [EJS](https://www.npmjs.com/package/ejs), among others.

To render template files, set the following [application setting properties](/en/4x/api/application#appsetname-value), in the default `app.js` created by the generator:
