...
<ul>
  <li markdown="1">
    The value of [req.hostname](/en/4x/api/request#reqhostname) is derived from the value set in the
  ...
  <li markdown="1">
    ...
    [req.protocol](/en/4x/api/request#reqprotocol).
  </li>
  <li markdown="1">
    The [req.ip](/en/4x/api/request#reqip) and [req.ips](/en/4x/api/request#reqips) values are
