...
This should not affect your code if you follow the Express 4 documentation of [app.param](/en/4x/api/application#appparamname-callback), as it makes no mention of the leading colon.
...
Details of how Express handles errors is covered in the [error handling documentation](/en/5x/guide/error-handling).
