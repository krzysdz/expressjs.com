...
Creates a new [router](/en/4x/api/router) object.
...
For more information, see [Router](/en/4x/api/router).
...
For more information, see [Serving static files in Express](/en/4x/starter/static-files).
and [Using middleware - Built-in middleware](/en/4x/guide/using-middleware#built-in-middleware).
...
- `res`, the [response object](/en/4x/api/response).
