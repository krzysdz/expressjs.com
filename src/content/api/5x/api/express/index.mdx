...
Creates a new [router](/en/5x/api/router) object.
...
For more information, see [Serving static files in Express](/en/5x/starter/static-files).
and [Using middleware - Built-in middleware](/en/5x/guide/using-middleware#built-in-middleware).
...
- `res`, the [response object](/en/5x/api/response).
